...
\subsection{\texorpdfstring{Uvjetno izvršavanje: \pyinline{if}, \pyinline{elif}, \pyinline{else}}{Uvjetno izvršavanje: if, elif, else}}
...
\subsection{\texorpdfstring{Ponavljanje: \pyinline{for} petlja}{Ponavljanje: for petlja}}
...
\section*{Vježbe za poglavlje \ref{chap:uvod}}
