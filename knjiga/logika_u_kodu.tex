...
% Output box environment for chapter files (with breakable)
...
\newtcblisting{pythoncode}[1][]{
    ...
    colback=codebg,
    colframe=pythonblue!40,
    listing only,
    left=5mm,
    enhanced,
    breakable,
    boxrule=0.5pt,
    underlay={\begin{tcbclipinterior}\fill[pythonblue!20] (frame.south west) rectangle ([xshift=5mm]frame.north west);\end{tcbclipinterior}},
    #1
}
...
% headheight is set correctly at line 62 (27.3pt), no override needed here
...
\vspace{0.3cm}
\textit{Prvo izdanje, Zagreb, Siječanj, 2026.}

\vspace{0.4cm}
 \href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{\includegraphics[height=1cm]{by-nc-nd.png}} 
\vspace{0.3cm}
